...
public class Listener {
    ...
    public Boolean listenOpeningTransaction(OpeningTransactionMessage message) {
        ...
        try {
            transactionService.save(new TransactionDto(4, message.accountNumberFrom(), message.accountNumberTo(), message.accountOwnerId(), message.accountOwnerId(), Instant.now(), "Apertura conto " + message.accountNumberTo(), message.amount()));
