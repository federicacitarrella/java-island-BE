...
public class TransactionController {
    ...
    public ResponseEntity<?> getTransactions(@RequestHeader("Authorization") String token, @PathVariable String accountNumber, @PathVariable int transactionsQuantity) {

        logger.info(">>> Request list transactions account " + accountNumber);

        //check transactionsQuantity
        try {
