...
public class Listener {
    ...
    public Boolean listen(CreationAccountMessage creationAccountMessage) {
        ...
        try {
            ...
            AccountDto newAccount = new AccountDto(accountNumber, creationAccountMessage.getFirstName(), creationAccountMessage.getLastName(), 0, 1, creationAccountMessage.getAccountOwnerId());
...
//            throw new RuntimeException();
    ...
    public int listenTransfer(TransferMessage message) {
        ...
        try {
            AccountDto accountFrom = accountService.findByAccountNumber(message.getAccountNumberFrom());

            if(message.getAccountOwnerId()==accountFrom.getAccountOwnerId()) {
                AccountDto accountTo = accountService.findByAccountNumber(message.getAccountNumberTo());
    ...
    public int listenTransaction(TransactionMessage message) {
        ...
        try {
            AccountDto account = accountService.findByAccountNumber(message.getAccountNumber());
            ...
            if(message.getAccountOwnerId()==account.getAccountOwnerId()) {
                ...
                if ((message.getAmount()!=0 && balance+message.getAmount() >= 0)) {
